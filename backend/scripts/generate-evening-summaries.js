#!/usr/bin/env node
/**
 * 🌙 Script Cron: Génération résumés du soir (20h)
 * Usage: node scripts/generate-evening-summaries.js
 */
...
async function main() {
  ...
  console.log('\n' + '='.repeat(70));
  console.log('🌙 CRON JOB: RÉSUMÉS DU SOIR (20H00)');
  ...
  try {
    ...
    const summaries = await generateMultilingualSummaries('evening');
    ...
    console.error('\n' + '='.repeat(70));
    console.error('❌ ERREUR GÉNÉRATION RÉSUMÉS SOIR');

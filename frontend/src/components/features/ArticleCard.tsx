...
interface Article {
  ...
  audio_url?: string | null  // Audio TTS du résumé (cache)
}
        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-1 sm:space-x-2">
              ...
              {/* Résumé audio — masqué temporairement (à remettre plus tard) */}
              {/* <AudioPlayButton articleId={article.id} initialUrl={article.audio_url} /> */}
            </div>
          </div>
        </div>
      </div>
    ...
    <div className={`p-3 sm:p-4 lg:p-6 rounded-lg shadow hover:shadow-md transition-shadow border ${
      ...
      <div className="flex items-start gap-3 sm:gap-4">
        ...
        <div className="flex-shrink-0 flex flex-col space-y-2">
          ...
          {/* Écouter le résumé (audio TTS) — masqué temporairement (à remettre plus tard) */}
          {/* <AudioPlayButton articleId={article.id} initialUrl={article.audio_url} /> */}
        </div>
      </div>
    </div>

      ...
      >
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          <div className="bg-white/10 backdrop-blur rounded-lg p-3 border border-white/15">
            <div className="text-sm text-white/70 mb-1">Secteur</div>
          ...
          <div className="bg-white/10 backdrop-blur rounded-lg p-3 border border-white/15">
            <div className="text-sm text-white/70 mb-1">Phase</div>
      ...
      >
        ...
        <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 rounded-xl p-4 border border-yellow-500/20">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-2xl font-bold text-slate-900">{completedActions}</div>
          </div>
          <div className="text-sm text-slate-700">Actions IA</div>
          <div className="text-xs text-slate-500 mt-1">sur {totalActions} lancées</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-xl p-4 border border-green-500/20">
          ...
          <div className="text-xs text-slate-500 mt-1">générés</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-indigo-500/10 to-purple-500/10 rounded-xl p-4 border border-indigo-500/20">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-2xl font-bold text-slate-900">{timelineCount}</div>
          </div>
          <div className="text-sm text-slate-700">Événements</div>
          <div className="text-xs text-slate-500 mt-1">dans l'historique</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-pink-500/10 to-rose-500/10 rounded-xl p-4 border border-pink-500/20">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="text-2xl font-bold text-slate-900">{notesCount}</div>
          </div>
          <div className="text-sm text-slate-700">Notes</div>
          <div className="text-xs text-slate-500 mt-1">personnelles</div>
        </div>
      </motion.div>

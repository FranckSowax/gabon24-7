    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <div className="bg-gray-800 rounded-full h-2">
          <div
            className="bg-gradient-to-r from-[#8a9576] to-[#697357] h-2 rounded-full transition-all"
      ...
      {step === 1 && (
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-6">
          <div>
            <label className="block text-[#697357] font-bold mb-3 flex items-center gap-2">
              ...
              {budgetOptions.map(level => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-xl border cursor-pointer transition-all ${selected ? 'bg-gradient-to-r from-[#697357]/20 to-[#8a9576]/20 border-[#697357]' : 'bg-white/5 border-white/10 hover:bg-white/10'}`}
                  >
      ...
      <div className="flex justify-between pt-2">
        ...
        {step < totalSteps ? (
          ...
          <button
            ...
            className="px-6 py-2 bg-gradient-to-r from-[#8a9576] to-[#697357] text-white rounded-lg hover:from-[#697357] hover:to-[#4d553e] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >

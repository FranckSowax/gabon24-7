...
const DEFAULT_FEATURES: Omit<PricingItem, 'id' | 'created_at' | 'updated_at'>[] = [
  ...
  { feature_key: 'business_plan', feature_name: 'Business Plan Complet', feature_description: 'Génération d\'un business plan professionnel', credits_cost: 100, ai_model: 'gpt-4-turbo-preview', estimated_api_cost_usd: 0.15, category: 'business', is_active: true },

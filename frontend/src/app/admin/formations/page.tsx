...
import { GraduationCap, Loader2, Check, X, Clock, Star, MapPin, Mail, Phone, BookOpen } from 'lucide-react'
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6">
      <header className="flex flex-wrap items-start justify-between gap-3">
        ...
        <a href="/admin/formations/cours"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#697357] hover:bg-[#4d553e] text-white text-sm font-semibold">
          <BookOpen className="w-4 h-4" /> Gérer les cours
        </a>
      </header>
